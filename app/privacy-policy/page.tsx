export default () => {
  return (
    <main className="p-20 leading-relaxed">
      ...
      <p>Effective date: 2024-07-25</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b> Cresteem</b>.
      </p>
      <p>
        <b>Cresteem</b> (“us”, “we”, or “our”) operates{" "}
        <b>bonse.cresteem.com</b> (hereinafter referred to as <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>bonse.cresteem.com</b>, and
      ...
      <p>
        <b>SERVICE</b> means the bonse.cresteem.com website operated by
        Cresteem.
      </p>
      <p>
      ...
      <p>Cresteem uses the collected data for various purposes:</p>
      ...
      <p>
        Cresteem will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        please send your request(s) by email: <b>support@cresteem.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>support@cresteem.com</b>.
      </p>
    </main>
  );
};
