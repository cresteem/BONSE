export default () => {
  return (
    <main className="p-20 leading-relaxed">
      <h2 style={{ textAlign: "center" }}>
        <b>TERMS AND CONDITIONS</b>
      </h2>
      <p>Last updated: 2024-07-25</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>Cresteem</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>bonse.cresteem.com</b> (together or
        individually “Service”) operated by <b>Cresteem</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>support@cresteem.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at support@cresteem.com.
      </p>
      ...
      <p>
        Cresteem has the right but not the obligation to monitor and edit all
        Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Cresteem or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        Cresteem and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to support@cresteem.com, with the subject line: “Copyright Infringement”
      ...
      <p>
        You can contact our Copyright Agent via email at support@cresteem.com.
      </p>
      <p>
        11. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at support@cresteem.com or via third
      ...
      <p>
        ...
        are not owned or controlled by Cresteem.
      </p>
      <p>
        Cresteem has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>support@cresteem.com</b>.
      </p>
    </main>
  );
};
